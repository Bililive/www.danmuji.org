...
# hide: true
title: 房管助手重制版
auther: Executor丶＆捅死小婊砸的点歌姬
plugin_author: Executor丶＆捅死小婊砸的点歌姬
plugin_name: 房管助手重制版
plugin_desc: 房管必备
plugin_version: 1.1.1
plugin_update_datetime: 2018-07-23 22:42:01 +0800
plugin_update_desc: |-
  添加了公告顺序发送一次的功能；向作者反馈、自动、手动封禁、手动报时按钮；插件整体请求结构优化
