...
plugin_version: 3.3.25.405
plugin_update_datetime: 2020-04-13 13:30:00 +0800
plugin_update_desc: |-
  [i] 本版本新增了 6 个功能，修正了 3 个问题。
  [+] 更新到最新的弹幕姬插件 SDK
  [+] 跟随弹幕姬更新，支持最新的 SuperChat（醒目消息）功能
  [+] 醒目消息可无视随机朗读限制
  [+] 朗读弹幕/礼物时可附加用户头衔（请参见插件介绍页面）
  [+] 可自定义用户头衔
  [+] 给调试模式加了点东西
  [√] 优化代码架构
  [√] 改善随机朗读效果
  [√] 连接成功/断开等事件朗读不再受随机朗读限制
